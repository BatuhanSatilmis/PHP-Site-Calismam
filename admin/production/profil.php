                          ...
                          <div class="x_content">
                              ...
                              <form action="../db/login_islemler.php"  method="POST" id="demo-form2"   enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="user_pass" value="<?php echo $kullaniciCek['user_pass']; ?>">
                                      </div>
                                  </div>
                                  <!-- Yuklu Logo -->
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                         ...
                                         <?php }
                                              ...
                                              {?>
                                                  <img  style="width: 200px; height: 200px;" src="sliderUploads/1603729974988.jpg">
                                         <?php  }
                                          ?>
