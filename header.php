...
<div class="body">
    <header id="header" class="header-no-border-bottom" data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 115, "stickySetTop": "-115px", "stickyChangeLogo": false}'>
        <div class="header-body" style="background-color: #000;">
                    ...
                    <div class="header-column">
                        <div class="header-logo">
                            <a href="index.php">
                                ...
                                {?>
                                    <img alt="<?php echo $ayarcek['ayar_title']?> logosu" width="253" height="114" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="../admin/<?php echo $ayarcek['ayar_logo']?>">

                                <?php }
                                else
                                {?>
                                    <img alt="" width="253" height="114" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="../images/logo_yok.png">
                           <?php  }
                            ...
                            <li>
                                <div class="feature-box feature-box-call feature-box-style-2">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="mb-none" style="color: #FFFF;"><?php echo $ayarcek['ayar_tel']?></h4>
                                    </div>
                                </div>
                            </li>
                            <li class="hidden-xs">
                                <div class="feature-box feature-box-mail feature-box-style-2">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="mb-none" style="color: #FFFF;"><a href="mailto:<?php echo $ayarcek['ayar_mail']?>" style="color: #FFFF;"><?php echo $ayarcek['ayar_mail']?></a></h4>
                                    </div>
                                </div>
                            </li>
                        </ul>
