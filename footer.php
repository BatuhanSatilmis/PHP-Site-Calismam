<footer class="short" id="footer">
        ...
        <div class="row">
            <div class="col-md-5">
                <a href="#" class="logo mb-md">
                    <img alt="Atakoy Cumhuriyet Sitesi" class="img-responsive" width="142" height="45" src="img/demos/logo/logo-law-firm-footer.png">
                </a>
                <p style="color: #FFFF;">İstanbul Bakırköy Ataköy 7-8-9.Kısım Mahallesinde bulunan Cumhuriyet Sitesi 1985 Yılında yapılmıştır. </p>
            </div>
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p style="color: #FFFF;">© Copyright 2020. All Rights Reserved.<?php  echo $ayarcek['ayar_author'];?> | <a href="#" target="_blank">Atakoy 7-8-9.Kisim Cumhuriyet Sitesi</a></p>
                </div>
            </div>
        </div>
    </div>
